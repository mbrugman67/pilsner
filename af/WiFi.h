...
public:
   ...
   IPAddress gatewayIP();
    ...
    int ping(const std::string &hostname, uint8_t ttl = 128);
    int ping(IPAddress host, uint8_t ttl = 128);

    void setPins(int8_t mosi, int8_t miso, int8_t clock, int8_t cs, int8_t ready, int8_t reset, int8_t gpio0);
