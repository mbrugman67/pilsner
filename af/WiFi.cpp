...
extern int8_t pCS, pReady, pReset, pGPIO0;
extern int8_t pMiso, pClock, pMosi;
...
void WiFiClass::setPins(int8_t mosi, int8_t miso, int8_t clock, int8_t cs, int8_t ready, int8_t reset, int8_t gpio0)
{
	pMosi = mosi;
	pMiso = miso;
	pClock = clock;
...
int WiFiClass::ping(const std::string &hostname, uint8_t ttl)
{
